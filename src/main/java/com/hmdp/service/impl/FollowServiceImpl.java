...
public class FollowServiceImpl extends ServiceImpl<FollowMapper, Follow> implements IFollowService {
    ...
    public Result follow(Long followUserId, Boolean isFollow) {
        ...
        if (Boolean.TRUE.equals(isFollow)) {
            ...
            if (!success) {
                return Result.fail("Follow failed");
            }
    ...
    private void sendFollowNotification(Long senderUserId, Long receiverUserId) {
        ...
        message.setBizId(senderUserId);
        message.setType(NotificationConstants.TYPE_FOLLOW);
        message.setContent(sender.getNickName() + " followed you");
