...
CREATE TABLE `tb_notification`  (
  ...
  `user_id` bigint(20) UNSIGNED NOT NULL COMMENT '����֪ͨ���û�id',
  `sender_user_id` bigint(20) UNSIGNED NOT NULL COMMENT '����֪ͨ���û�id',
  `type` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '֪ͨ����',
  `biz_id` bigint(20) UNSIGNED NOT NULL COMMENT '����ҵ��id',
  `content` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '֪ͨ����',
  `read_status` tinyint(1) UNSIGNED NOT NULL DEFAULT 0 COMMENT '0δ�� 1�Ѷ�',
